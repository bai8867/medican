...
import { isUserDisabled } from '@/utils/adminUserStatus.js'
import {
  hasPortalCampusOk,
  hasPortalAdminOk,
  stashCampusRedirect,
...
import { maybeProbeCampusAccountStatus } from '@/utils/campusAccountProbe.js'
...
const routes = [
  ...
  },
  {
    ...
    component: () => import('@/views/CampusWeeklyCalendar.vue'),
    meta: { title: '本周药膳日历' },
  },
  {
    path: '/constitution',
  ...
  },
  {
    path: '/ai/plan/:id',
    name: 'AIPlanDetail',
    component: () => import('@/views/AIPlanDetail.vue'),
    meta: { title: 'AI 方案详情' },
  },
  {
    path: '/profile',
  ...
  },
  {
    path: '/scenes',
    name: 'CampusScenes',
    component: () => import('@/views/CampusScenes.vue'),
    meta: { title: '场景食疗' },
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'recipe',
        name: 'AdminRecipe',
        component: () => import('@/views/admin/AdminRecipe.vue'),
